...
import { DexToolsAboutComponent } from './components/about/about.component';
import { DexToolsHomeComponent } from './components/home/home.component';
import { DexToolsSwapComponent } from './components/swap/swap.component';
import { DexToolsLiquidityComponent } from './components/liquidity/liquidity.component';
import { DexToolsFarmingComponent } from './components/farming/farming.component';

@Component({
  standalone: true,
  selector: 'sbx-dex-tools',
  imports: [
    CommonModule,
    SbxHeaderComponent,
    SbxFooterComponent,
    DexToolsAboutComponent,
    DexToolsHomeComponent,
    DexToolsSwapComponent,
    DexToolsLiquidityComponent,
    DexToolsFarmingComponent,
  ],
  templateUrl: './dex-tools.page.html',
  styleUrls: ['./dex-tools.page.scss'],
  providers: [
    {
