// src/features/wallet-tools/contracts/auction.abi.ts
...
export const AUCTION_ABI = [
  {
    inputs: [
      { internalType: 'address', name: 'ast', type: 'address' },
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'contract IAmfiPureMint',
        name: '',
        type: 'address',
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'amountAST', type: 'uint256' },
    ],
    name: 'placeBid',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'highestBidAST', type: 'uint256' },
